         ...
         <Card className="md:col-span-3 hover:shadow-md transition-shadow bg-blue-50/50">
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground leading-relaxed">
              Ticket numbers and status changes are dynamically synchronized with the FastAPI PostgreSQL backend on every request via Next.js server components. No client-side Javascript is required to render these metrics.
            </p>
          </CardContent>
        </Card>
      </div>
